                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/men-01.jpg" alt="TV Samsung mod. 1" />
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/men-02.jpg" alt="TV Samsung mod. 2" />
                                </div>
                                <div className="down-content">
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/men-03.jpg" alt="TV Samsung mod. 3" />
                                </div>
                                <div className="down-content">
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/women-01.jpg" alt="TV LG mod. 1" />
                                </div>
                                <div className="down-content">
                                    <h4>TV LG mod. 1</h4>
                                    <span>$0.00</span>
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/women-02.jpg" alt="TV LG mod. 2" />
                                </div>
                                <div className="down-content">
                                    <h4>TV LG mod. 2</h4>
                                    <span>$0.00</span>
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/women-03.jpg" alt="TV LG mod. 3" />
                                </div>
                                <div className="down-content">
                                    <h4>TV LG mod. 3</h4>
                                    <span>$0.00</span>
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/kid-01.jpg" alt="TV Kalley mod. 1" />
                                </div>
                                <div className="down-content">
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/kid-02.jpg" alt="TV Kalley mod. 2" />
                                </div>
                                <div className="down-content">
                        ...
                        <div className="col-lg-4">
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <img src="assets/images/kid-03.jpg" alt="TV Kalley mod. 3" />
                                </div>
                                <div className="down-content">
