                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="section-heading">
                                <h2>Televisores Samsung</h2>
                                <span>Explora los TVs Samsung y descubre el que mejor se adapte a ti.</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="section" id="women">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="section-heading">
                                <h2>Televisores LG</h2>
                                <span>Todo es posible. No lo pienses más, compra el tuyo ahora.</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="section" id="kids">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="section-heading">
                                <h2>Televisores Kalley</h2>
                                <span>Llevamos a los hogares los avances tecnológicos a un mejor precio.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="section-heading">
                                <h2>Otras Marcas</h2>
                                <span>Tenemos la mayor variedad en diferentes marcas y tecnologías para tu entretenimiento.</span>
                            </div>
                        </div>
                    </div>
                </div>
